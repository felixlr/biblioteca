<?php
	...
	if(isset($_POST['contrasenia'])){
		$elementosObligatorios=array('usuario','dni','contrasenia','contraseniaConf');
	}
	else{
		$elementosObligatorios=array('usuario','dni');
	...
	if(!$faltanCamposObligatorios){
		//Inicio la conexion si no faltan campos obligatorios
		$idConexion=conectar();
		//Validar si esta editando la contraseña
		if(isset($_POST['contrasenia'])){
