<form enctype="multipart/form-data" role="form" class="form-horizontal" action="procesar/procesarNuevoLibro.php" method="POST">
	<fieldset>
		<div class="col-xs-12">
		...
		<div class="form-group">
			...
			<div class="col-xs-7" style="top:4px;">
				<input type="file" id="portadaLibro" name="imagen">
			</div>
		</div>
		<div class="form-group">
			<div class="col-xs-4">
