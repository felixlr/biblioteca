<?php
	...
	echo '
		...
		<fieldset>
			...
			<div class="form-group">
				<label for="telefono" class="col-xs-3 control-label">Teléfono:</label>
				<div class="col-xs-4">
					<input id="telefono" type="text" class="form-control" name="telefono" placeholder="Teléfono">
				</div>
			</div>
			<div class="form-group">
				<label for="movil" class="col-xs-3 control-label">Móvil:</label>
				<div class="col-xs-4">
					<input id="movil" type="text" class="form-control" name="movil" placeholder="Móvil">
				</div>
			</div>
			<div class="form-group">
				<label for="e-mail" class="col-xs-3 control-label">Correo Electrónico:</label>
				<div class="col-xs-7">
					<input id="e-mail" type="text" class="form-control" name="email" placeholder="ejemplo@dominio.com">
				</div>
			</div>
			<div class="form-group">
				<label for="anioProfesor" class="col-xs-3 control-label">Año:</label>
				<div class="col-xs-4">
