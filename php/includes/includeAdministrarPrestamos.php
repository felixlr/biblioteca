			...
			while($fila2=mysql_fetch_array($datos2)){
				echo '
						<tr>
							...
							<td>
								<a class="btn btn-info btn-sm" href="edicionPrestamo.php?idPrestamo='.$fila2['idPrestamo'].'" title="Editar"><span class="glyphicon glyphicon-edit"></span></a>
								<a class="btn btn-warning btn-sm" href="finalizarPrestamo.php?idPrestamo='.$fila2['idPrestamo'].'&idLibro='.$fila2['idLibro'].'&idEjemplar='.$fila2['idEjemplar'].'" title="Eliminar"><span class="glyphicon glyphicon-trash"></a>
							</td>
						</tr>
				';
			}
