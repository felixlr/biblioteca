<?php
	...
	if(isset($_SESSION['usuario']) && $_SESSION['tipoCuenta']=="A"){
		...
		$consulta="UPDATE ejemplares SET idLibro='".$_POST['idLibro']."',num='".$_POST['num']."',localizacion='".$_POST['localizacion']."',comentarios='".$_POST['comentarios']."' WHERE idLibro='".$_SESSION['idLibro']."' AND num='".$_SESSION['num']."'";
